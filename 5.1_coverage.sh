...
grep "RLG" data/results/all.gff | grep -v "TRIM" > data/results/all_rlg.gff
grep "RLC" data/results/all.gff | grep -v "TRIM" > data/results/all_rlc.gff
grep "RLX" data/results/all.gff | grep -v "TRIM" > data/results/all_rlx.gff
grep "DTM" data/results/all.gff > data/results/all_dtm.gff
grep "DTC" data/results/all.gff > data/results/all_dtc.gff
