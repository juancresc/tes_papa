...
grep "RLG" data/results/all.noun.gff > data/results/all_rlg.gff
grep "RLC" data/results/all.noun.gff > data/results/all_rlc.gff
grep "RLX" data/results/all.noun.gff > data/results/all_rlx.gff
